...
/*!
 * \file
 * \brief Definicja klasy XMLParser4Scene
 *
 * Plik zawiera definicję klasy XMLParser4Scene
 */
...
/*!
 *\brief Przetwarza parametry obiektu.
 */
  void ProcessObjectAttrs(const xercesc::Attributes &Attrs); 
  
/*!
 *\brief Przetwarza parametry robota.
 */
  void ProcessRobotAttrs(const xercesc::Attributes   &Attrs );    
